...
#define SETUP_FIELD(NAME, KEY, PATH, ACCESS, ACCESS_EDIT, SEARCHABLE) GETTER_SETTER(PATH, KEY); /datum/report_field/##PATH/##KEY;\
/datum/computer_file/report/crew_record/generate_fields(){..(); var/datum/report_field/##KEY = add_field(/datum/report_field/##PATH/##KEY, ##NAME, searchable = SEARCHABLE);\
...
#define FIELD_SHORT(NAME, KEY, ACCESS, ACCESS_EDIT, SEARCHABLE) SETUP_FIELD(NAME, KEY, simple_text/crew_record, ACCESS, ACCESS_EDIT, SEARCHABLE)
#define FIELD_LONG(NAME, KEY, ACCESS, ACCESS_EDIT) SETUP_FIELD(NAME, KEY, pencode_text/crew_record, ACCESS, ACCESS_EDIT, 0)
#define FIELD_NUM(NAME, KEY, ACCESS, ACCESS_EDIT) SETUP_FIELD(NAME, KEY, number/crew_record, ACCESS, ACCESS_EDIT, 0)
#define FIELD_LIST(NAME, KEY, OPTIONS, ACCESS, ACCESS_EDIT) FIELD_LIST_EDIT(NAME, KEY, OPTIONS, ACCESS, ACCESS_EDIT)
#define FIELD_LIST_EDIT(NAME, KEY, OPTIONS, ACCESS, ACCESS_EDIT) SETUP_FIELD(NAME, KEY, options/crew_record, ACCESS, ACCESS_EDIT, 0);\
/datum/report_field/options/crew_record/##KEY/get_options(){return OPTIONS}

// GENERIC RECORDS
FIELD_SHORT("Name", name, null, access_change_ids, 1)
FIELD_SHORT("Formal Name", formal_name, null, access_change_ids, 0)
FIELD_SHORT("Job", job, null, access_change_ids, 0)
...
FIELD_SHORT("Species",species_name, null, access_change_ids, 0)
FIELD_LIST("Branch", branch, record_branches(), null, access_change_ids)
FIELD_LIST("Rank", rank, record_ranks(), null, access_change_ids)
FIELD_SHORT("Religion", religion, access_chapel_office, access_change_ids, 0)
...
FIELD_SHORT("DNA", dna, access_security, access_security, 1)
FIELD_SHORT("Fingerprint", fingerprint, access_security, access_security, 1)

// EMPLOYMENT RECORDS
FIELD_LONG("Employment Record", employment_record, access_bridge, access_bridge)
FIELD_SHORT("Home System", homeSystem, access_bridge, access_change_ids, 0)
FIELD_SHORT("Faction", faction, access_bridge, access_bridge, 0)
