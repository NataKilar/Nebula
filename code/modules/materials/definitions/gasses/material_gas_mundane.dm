/decl/material/gas/oxygen
	...
	liquid_specific_heat = 1.71
	liquid_density = 1.15
	molar_mass = 0.032
	vaporization_heat = 213
...
/decl/material/gas/helium
	...
	liquid_specific_heat = 2.7 // Tricky due to the superfluid transition. This is roughly correct.
	liquid_density = 0.14
	molar_mass = 0.004
	vaporization_heat = 21
...
/decl/material/gas/carbon_dioxide
	...
	liquid_specific_heat = 0.59
	liquid_density = 0.8 // No data, sublimates at SP
	molar_mass = 0.044
...
/decl/material/gas/carbon_monoxide
	...
	gas_specific_heat = 30
	liquid_specific_heat = 2.143
	liquid_density = 0.8
	molar_mass = 0.028
	vaporization_heat = 216
...
/decl/material/gas/methyl_bromide
	...
	liquid_specific_heat = 2 // No data
	liquid_density = 1.72
	molar_mass = 0.095
	vaporization_heat = 253
...
/decl/material/gas/nitrous_oxide
	...
	liquid_specific_heat = 1.72
	liquid_density = 1.23
	molar_mass = 0.044
	vaporization_heat = 376
...
/decl/material/gas/nitrogen
	name = "nitrogen"
	uid = "gas_nitrogen"
	lore_text = "A ubiquitous inert gas."
	gas_specific_heat = 20
	liquid_specific_heat = 2.04
	liquid_density = 0.81
	molar_mass = 0.028
	vaporization_heat = 199
...
/decl/material/gas/nitrodioxide
	...
	liquid_specific_heat = 0.83
	liquid_density = 1.4 // No data.
	molar_mass = 0.054
	vaporization_heat = 272
...
/decl/material/gas/nitricoxide
	...
	liquid_specific_heat = 1.01
	liquid_density = 1 // No data
	molar_mass = 0.030
	vaporization_heat = 410
...
/decl/material/gas/methane
	...
	uid = "gas_methane"
	gas_specific_heat = 30
	liquid_specific_heat = 3.47
	liquid_density = 0.42
	molar_mass = 0.016
	vaporization_heat = 510
...
/decl/material/gas/argon
	...
	gas_specific_heat = 10
	liquid_specific_heat = 1.12
	liquid_density = 1.4
	molar_mass = 0.039
	vaporization_heat = 163
...
/decl/material/gas/krypton
	...
	uid = "gas_krypton"
	gas_specific_heat = 5
	liquid_specific_heat = 1.12 // No data, krypton sublimates for most pressures.
	liquid_density = 1.4
	molar_mass = 0.083
	vaporization_heat = 108
...
/decl/material/gas/neon
	...
	uid = "gas_neon"
	gas_specific_heat = 20
	liquid_specific_heat = 1.87
	liquid_density = 1.22
	molar_mass = 0.02
	vaporization_heat = 86
...
/decl/material/gas/ammonia
	...
	uid = "gas_ammonia"
	gas_specific_heat = 20
	liquid_specific_heat = 4.44
	liquid_density = 0.68
	molar_mass = 0.017
	vaporization_heat = 1370
...
/decl/material/gas/xenon
	...
	uid = "gas_xenon"
	gas_specific_heat = 3
	liquid_specific_heat = 3.34
	liquid_density = 2.95
	molar_mass = 0.131
	vaporization_heat = 96
...
/decl/material/gas/sulfur_dioxide
	...
	gas_specific_heat = 30
	liquid_specific_heat = 0.4 // No data
	liquid_density = 0.6
	molar_mass = 0.064
	vaporization_heat = 389
...
/decl/material/gas/hydrogen
	...
	liquid_specific_heat = 9.22
	liquid_density = 0.07
	molar_mass = 0.002
	vaporization_heat = 454
