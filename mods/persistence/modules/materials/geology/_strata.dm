...
/decl/strata/asteroid/magnetite
...
/decl/strata/asteroid/shimmering
	...
	ores_rich = list(
		...
		/decl/material/solid/mineral/gold = 2
	)
...
/decl/strata/asteroid/rich
	...
	ores_sparse = list(
		...
		/decl/material/solid/mineral/gold = 5,
	...
	ores_rich = list(
		...
		/decl/material/solid/mineral/gold = 10,
		/decl/material/solid/mineral/sperrylite = 20,
		/decl/material/solid/mineral/calaverite = 20,
		/decl/material/solid/diamond = 3
	)
